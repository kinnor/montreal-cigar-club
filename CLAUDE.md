...
- Domains (purchased 2026-08-29, Cloudflare Registrar): **`montrealcigarclub.ca`** (primary), **`mtlcigarclub.ca`** and **`mtlcigarclub.com`** (both 301 redirect to primary; .com added later on 2026-08-29). No `.com` owned. Hosting: Cloudflare Pages; Email Routing ACTIVE (2026-08-29): `concierge@`, `admissions@`, `vault@` → rossen.kinov@gmail.com. Outbound (form notifications) still needs Email Sending onboarding + `EMAIL_API_TOKEN`. Preview locally with `python -m http.server 8080`.
